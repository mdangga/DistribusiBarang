            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center gap-4">
                        ...
                        <h5 class="text-xl font-semibold whitespace-nowrap">Detail Pesanan
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div>
                            ...
                            <div class="bg-gray-100 px-4 py-2 rounded">{{ $pesanan->created_at->format('d/m/Y') }}
                            </div>
                        </div>
                        <div>
                            <div class="font-semibold mb-1">ID Pelanggan</div>
                            <div class="bg-gray-100 px-4 py-2 rounded">{{ $pesanan->id_pelanggan ?? 'Tidak ada' }}
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center px-4 py-4 text-gray-500">Tidak ada
                                            detail
                                            pesanan</td>
                                    </tr>
                                @endforelse
