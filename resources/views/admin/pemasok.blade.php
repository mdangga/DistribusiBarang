...
<body class="bg-graymain">
    ...
    <div class="p-4 sm:ml-64 mt-14 sm:mt-0">
        {{-- validasi modal --}}
        <x-toast-info :fields="['nama_pemasok', 'no_telpon', 'alamat']" type="error" />
        @if (session('success'))
        ...
        <div class="flex items-center justify-between ml-2 mb-2">
            ...
            <button data-modal-target="addModalPemasok" data-modal-toggle="addModalPemasok" type="button"
            ...
            <div class="relative overflow-x-auto">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                        <tr class="text-sm">
                            <th scope="col" class="px-6 py-3"><a
                                    href="{{ SortHelper::sortUrl('id_pemasok') }}">ID
                                    {{ SortHelper::sortArrow('id_pemasok') }}</a></th>
                            <th scope="col" class="px-6 py-3"><a
                                    href="{{ SortHelper::sortUrl('nama_pemasok') }}">Nama
                                    {{ SortHelper::sortArrow('nama_pemasok') }}</a></th>
                            ...
                            <th scope="col" class="px-6 py-3">
                                <a href="{{ SortHelper::sortUrl('total_pengiriman') }}">Total Pengiriman
                                    {{ SortHelper::sortArrow('total_pengiriman') }}</a>
                            </th>
                    ...
                    <tbody>
                        @forelse ($pemasok as $item)
                            <tr class= "bg-white border-b border-gray-200">
                                <td class="px-6 py-4 max-w-[50px]">
                                    {{ 'SUP' . str_pad($item->id_pemasok, 3, '0', STR_PAD_LEFT) }}
                                </td>
                                {{-- <td class="px-6 py-4">
                                <!-- Trigger Modal -->
                                ...
                                <td class="px-6 py-4 max-w-[290px] truncate">
                                    {{ $item->nama_pemasok }}
                                    </a></td>
                                <td class="px-6 py-4 max-w-[160px] truncate">{{ $item->no_telpon }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div
                                        ...
                                        <!-- Tombol Edit -->
                                        <a data-modal-target="editModal{{ $item->id_pemasok }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="bg-white text-center text-gray-500 py-6">Data pemasok tidak
                                    ada</td>
                            </tr>
                        @endforelse
                    </tbody>
