        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-sidebar ">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-700 rounded-lg  hover:bg-gray-100 group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 text-gray-700 transition duration-75  group-hover:text-gray-900 "
                ...
                {{-- <x-button-sidebar route="#"
                    icon='<path d="M304 240V16.6c0-9 7-16.6
                    16-16.6c123.7 0 224 100.3 224 224c0 9-7.6 16-16.6 16zM32 272c0-121.3 90.1-221.7 207-237.7c9.2-1.3 17
                    6.1 17 15.4V288l156.5 156.5c6.7 6.7 6.2 17.7-1.5 23.1c-39.2 28-87.2 44.4-139 44.4c-132.5
                    0-240-107.4-240-240m526.4 16c9.3 0 16.6 7.8 15.4 17c-7.7 55.9-34.6 105.6-73.9 142.3c-6 5.6-15.4
                    5.2-21.2-.7L320 288z "/>'>
                    Dashboard
                </x-button-sidebar> --}}
                ...
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-700 rounded-lg  hover:bg-gray-100  group">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="shrink-0 w-5 h-5 text-gray-700 transition duration-75  group-hover:text-gray-900 "
                            width="640" height="512" viewBox="0 0 640 512">
                            <path fill="currentColor"
                        ...
                        {{-- <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-700 bg-mintgreen rounded-full  ">66</span> --}}
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 text-gray-700 rounded-lg  hover:bg-gray-100  group">
                ...
                <hr class="h-px my-8 bg-black/20 border-0 ">
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-700 rounded-lg  hover:bg-gray-100  group">
                        <svg class="shrink-0 w-5 h-5 text-gray-700 transition duration-75  group-hover:text-gray-900 "
